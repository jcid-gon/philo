...
/*   Updated: 2022/01/11 12:42:10 by jcid-gon         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_eat(t_philos *philos)
{
	...
	if (philos->base->philo_num == 1)
		ft_wait(ft_get_time() + philos->base->death_time + 1, philos->base);
	else
	{
		philos->state = 2;
		...
		ft_wait(ft_get_time() + philos->base->sleep_time, philos->base);
	}
}
